...
contract myToken {
    ...
    // In the 2nd mapping, it says who can spend on your behalf, and how much
    // So, we are creating a mapping, where the key is an address
    // The value is futher a mapping of address to amount
    ...
    // So the msg.sender is approvinf the spender to spend these many tokens
